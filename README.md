...
[![NPM version](https://img.shields.io/npm/v/tesseract.svg)](https://npmjs.org/package/tesseract) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/tesseract)
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/tesseract-node.git
```

> [!NOTE]
> Once this package is [published to npm](https://app.stainlessapi.com/docs/guides/publish), this will become: `npm install tesseract`
...
To do the inverse, add `import "tesseract/shims/node"` (which does import polyfills).
This can also be useful if you are getting the wrong TypeScript types for `Response` ([more details](https://github.com/stainless-sdks/tesseract-node/tree/main/src/_shims#readme)).
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/tesseract-node/issues) with questions, bugs, or suggestions.
